...
y2 = svc.predict(x_further)
x1=svc.predict(x_train)
from sklearn.metrics import accuracy_score
print("accuracy of the model is:\nTest ", accuracy_score(y_further, y2, normalize=True, sample_weight=None))
print('Train',accuracy_score(y_train,x1, normalize=True, sample_weight=None))